...
__all__ = [
    'DISPID_SVSLastResult', 'SP_VISEME_1', 'SAFT16kHz8BitStereo',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRRSetTextFeedback',
    'ISpEventSource', 'SRERequestUI',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechDataKey',
    'SVESentenceBoundary', 'SpeechTokenValueCLSID',
    'ISpeechGrammarRules', 'DISPID_SRCERequestUI',
    'SAFT11kHz8BitMono', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SLWLangId', 'SSFMOpenReadWrite', 'DISPID_SRGReset',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE6', 'SRSActiveAlways',
    'eLEXTYPE_PRIVATE12', 'DISPID_SWFEBlockAlign',
    'DISPID_SWFEChannels', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechVoiceEvents', 'SpPhoneticAlphabetConverter', 'SPEI_VISEME',
    'DISPID_SRSSupportedLanguages', 'DISPID_SWFEExtraData', 'SVP_7',
    'SWPUnknownWordPronounceable', 'SVP_20', 'DISPID_SPPConfidence',
    'SPWF_SRENGINE', 'SpeechInterference', 'DISPID_SpeechPhraseRules',
    'SGDSActiveWithAutoPause', 'ISpeechPhraseElement', 'SVP_0',
    'SpStreamFormatConverter', 'ISpRecoCategory',
    'SpInProcRecoContext', 'SVP_4', 'ISpRecoContext',
    'DISPID_SVPause', 'tagSPPROPERTYINFO', 'SPSHORTCUTPAIRLIST',
    'SAFTCCITT_ALaw_22kHzMono', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRIsShared', 'SPSSuppressWord',
    'DISPIDSPTSI_SelectionOffset', 'SRTReSent',
    'DISPID_SPIProperties', 'SPSHT_EMAIL', 'SPGRAMMARSTATE',
    'SpVoice', 'SpeechEngineProperties', 'SPEI_RESERVED3',
    'DISPID_SPPsCount', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRSTPropertyValue',
    'SpeechPartOfSpeech', 'SRAONone', 'ISpPhraseAlt',
    'DISPID_SPIAudioStreamPosition', 'SpeechVoiceCategoryTTSRate',
    'SP_VISEME_21', 'SAFT8kHz8BitStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRSTsCount', 'SPAS_PAUSE', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechLexiconWords', 'SAFTADPCM_11kHzMono', 'SPCT_SLEEP',
    'SRCS_Disabled', 'DISPID_SVGetAudioInputs',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpMMSysAudio',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRGSetWordSequenceData', 'SPSInterjection', 'ISpPhrase',
    'SPEI_PHONEME', 'SSTTWildcard', 'SVP_9', 'SPLO_STATIC',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRSTransitions',
    'eLEXTYPE_USER', 'DISPID_SDKSetStringValue', 'SVP_14',
    'SpeechTokenKeyAttributes', 'SFTSREngine',
    'DISPID_SPPEngineConfidence', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SECFIgnoreCase', 'DISPID_SpeechLexiconWord', 'STCLocalServer',
    'DISPID_SpeechGrammarRules',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SLWsCount',
    'DISPID_SFSClose', 'SREHypothesis', 'ISpeechXMLRecoResult',
    'SpeechCategoryAudioIn', 'SAFTDefault', 'DISPID_SMSSetData',
    'eLEXTYPE_RESERVED8', 'SPEI_RESERVED6', 'SECFIgnoreWidth',
    'DISPID_SGRsItem', 'SPDATAKEYLOCATION', 'DISPID_SpeechAudio',
    'ISpeechLexiconWords', 'SpeechCategoryAudioOut',
    'DISPID_SOTDataKey', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVEWord', 'SVP_6',
    'SPPS_Unknown', 'SVEWordBoundary', 'DISPID_SVResume',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SABufferNotifySize',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVSInputWordLength',
    'DISPID_SRGRules', 'DISPID_SPEDisplayText', 'ISpeechAudio',
    'STSF_LocalAppData', 'SPGS_ENABLED',
    'SpeechStreamSeekPositionType', 'SPINTERFERENCE_TOOQUIET',
    'tagSPTEXTSELECTIONINFO', 'SPEI_ADAPTATION',
    'SAFTCCITT_uLaw_8kHzMono', 'eLEXTYPE_PRIVATE17',
    'DISPID_SDKCreateKey', 'Speech_StreamPos_Asap',
    'SpInprocRecognizer', 'SPFM_CREATE_ALWAYS', 'SINone',
    'SECNormalConfidence', 'eLEXTYPE_RESERVED4', 'SRTExtendableParse',
    'SPEI_SOUND_START', 'SP_VISEME_2', 'SDTAudio',
    'DISPID_SLGetGenerationChange', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPEEngineConfidence', 'DISPID_SPIStartTime',
    'SPFM_CREATE', 'DISPID_SVSpeak', 'SPPS_Function', 'SPXRO_SML',
    'SPWT_DISPLAY', 'DISPID_SpeechPhraseProperties', 'SVEAllEvents',
    'ISpEventSink', 'DISPID_SPRuleNumberOfElements', 'SpCustomStream',
    'DISPID_SLRemovePronunciation', 'DISPID_SPEAudioTimeOffset',
    'eLEXTYPE_RESERVED10', 'SASStop', 'SPINTERFERENCE_NONE',
    'DISPID_SASFreeBufferSpace', 'SAFT16kHz16BitStereo',
    'DISPID_SGRSTPropertyName', 'SDKLDefaultLocation',
    'eWORDTYPE_ADDED', 'SPDKL_CurrentUser', 'DISPID_SPILanguageId',
    'ISpeechPhraseProperties', 'SpSharedRecognizer',
    'DISPID_SAVolume', 'SGRSTTWord', 'SAFTGSM610_8kHzMono',
    'SREStreamStart', 'SVEBookmark', 'SECFDefault',
    'ISpeechAudioBufferInfo', 'SSTTDictation', 'SREAudioLevel',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SBSWrite',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechRecoResult2',
    'SpeechVisemeType', 'eLEXTYPE_PRIVATE4', 'DISPID_SLWs_NewEnum',
    'SPVPRI_ALERT', 'SPWORDPRONUNCIATIONLIST', 'SECLowConfidence',
    'DISPID_SPRuleParent', 'DISPID_SOTGetStorageFileName',
    'DISPID_SLPLangId', 'DISPID_SRGCommit', 'SDTLexicalForm',
    'ISpeechPhraseAlternate', 'DISPID_SGRsCommit',
    'SPAO_RETAIN_AUDIO', 'SPRST_INACTIVE_WITH_PURGE',
    ...
    'DISPID_SGRAddState', 'DISPID_SPEAudioSizeBytes',
    'SPEI_FALSE_RECOGNITION', 'SpeechFormatType', 'SPEI_SOUND_END',
    'SPSVerb', 'SpeechCategoryAppLexicons', 'SAFT22kHz8BitStereo',
    'SRSInactiveWithPurge', 'SpeechSpecialTransitionType',
    'SAFT24kHz8BitStereo', 'DISPID_SFSOpen', 'ISpRecoGrammar2',
    'SPRST_INACTIVE', 'DISPID_SREmulateRecognition',
    'ISpNotifySource', 'DISPID_SPEsItem', 'SPSUnknown',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTADPCM_44kHzStereo',
    'DISPID_SWFEFormatTag', 'DISPID_SLGetWords', 'DISPID_SRProfile',
    'eLEXTYPE_PRIVATE1', 'ISpeechLexiconPronunciations',
    'SpResourceManager', 'ISpeechRecoResult',
    'ISpeechPhraseAlternates', 'SPEI_END_INPUT_STREAM',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRSClsidEngine',
    'SAFTNoAssignedFormat', 'SAFT24kHz16BitMono',
    'DISPID_SpeechMemoryStream', 'DISPID_SGRAddResource',
    'eLEXTYPE_MORPHOLOGY', 'SAFTGSM610_44kHzMono',
    'ISpeechAudioFormat', 'SPPHRASEREPLACEMENT', 'SPAUDIOSTATUS',
    'SPRS_INACTIVE', 'DISPID_SRGDictationLoad', 'SRESoundStart',
    'SP_VISEME_3', 'SP_VISEME_5', 'ISpeechPhraseRule',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SOTGetDescription', 'DISPID_SOTRemove', 'DISPID_SRCState',
    'SAFTCCITT_uLaw_44kHzMono', 'SP_VISEME_14',
    'DISPID_SDKSetLongValue', 'DISPID_SPRText', 'SPCS_DISABLED',
    'SpMMAudioIn', 'SRTStandard', 'DISPID_SRIsUISupported',
    'DISPID_SPRulesItem', 'DISPID_SOTSetId', 'SPWF_INPUT',
    'DISPID_SRGIsPronounceable', 'SGDSActive', 'SDTPronunciation',
    'ISpeechFileStream', 'DISPID_SRSetPropertyNumber',
    'DISPID_SVEEnginePrivate', 'SVSFParseMask', 'DISPID_SPPs_NewEnum',
    'SRTSMLTimeout', 'ISpeechObjectToken', 'DISPID_SGRSTs_NewEnum',
    'ISpeechDataKey', 'SPVISEMES', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRName', 'SpLexicon', 'ISpeechCustomStream',
    'SpeechGrammarTagWildcard', 'SVSFParseSsml',
    'SVEStartInputStream', 'SRATopLevel', 'SAFTGSM610_11kHzMono',
    'SpMemoryStream', 'SPEI_SR_PRIVATE', 'SPWAVEFORMATTYPE',
    'SPDKL_CurrentConfig', 'DISPID_SGRsAdd', 'SDTProperty',
    'SAFT12kHz16BitStereo', 'DISPID_SRGetPropertyString',
    'SAFT8kHz16BitMono', 'DISPID_SMSALineId',
    'DISPID_SDKGetlongValue', 'ISpeechVoice',
    'DISPIDSPTSI_ActiveOffset', 'SAFT32kHz8BitStereo',
    'DISPID_SPCIdToPhone', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRGId', 'IInternetSecurityMgrSite', 'SPAUDIOOPTIONS',
    'DISPID_SVAudioOutput', 'SpeechDiscardType',
    'DISPID_SRCEBookmark', 'DISPID_SDKEnumKeys', 'SAFT48kHz16BitMono',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_RESERVED9', 'SGRSTTDictation',
    'DISPID_SPRules_NewEnum', 'SVP_11', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPPName', 'DISPID_SPPValue', 'DISPID_SRRAudioFormat',
    'DISPID_SGRSTType', 'DISPID_SASNonBlockingIO',
    'DISPID_SAEventHandle', 'SDTAll', 'ISpDataKey', 'SPCATEGORYTYPE',
    'SRSEDone', 'SPEVENTSOURCEINFO', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTWeight',
    'ISpStreamFormat', 'SPEI_TTS_PRIVATE', 'DISPID_SpeechPhraseRule',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SOTCategory',
    'SRERecoOtherContext', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCEInterference',
    'DISPID_SASState', 'SpeechRuleAttributes', 'SECFIgnoreKanaType',
    'DISPID_SPCPhoneToId', 'DISPID_SRGCmdLoadFromObject',
    'SVEPhoneme', 'SpeechCategoryPhoneConverters',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPELexicalForm',
    'SpeechRuleState', 'Speech_Max_Word_Length',
    'SpeechDictationTopicSpelling', 'DISPID_SGRId', 'STSF_AppData',
    'SSSPTRelativeToEnd', 'SSFMOpenForRead', 'SVP_8',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCPause', 'SPCT_COMMAND',
    'DISPID_SLPsItem', 'SGSEnabled', 'SAFT22kHz16BitMono',
    'DISPID_SVEPhoneme', 'SRTEmulated', 'SRARoot', 'SRAORetainAudio',
    'SPAS_CLOSED', 'SPPS_Modifier', 'DISPID_SVSLastBookmark',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRRRecoContext',
    'SPCS_ENABLED', 'SPVOICESTATUS', 'DISPID_SPAs_NewEnum',
    'ISpeechLexiconWord', 'SVSFDefault', 'DISPID_SRCEventInterests',
    'SpeechPropertyNormalConfidenceThreshold', 'SRAExport',
    'DISPID_SVVolume', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechPhraseProperty', 'SP_VISEME_10',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPEActualConfidence', 'DISPIDSPRG',
    'DISPID_SRSetPropertyString', 'SPSHT_Unknown',
    'SAFT44kHz16BitStereo', 'SAFTADPCM_22kHzStereo',
    'eLEXTYPE_PRIVATE10', 'SPEI_END_SR_STREAM',
    'SPINTERFERENCE_TOOLOUD', 'ISpGrammarBuilder', 'DISPID_SLWsItem',
    'SPLO_DYNAMIC', 'SPSLMA', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SDKSetBinaryValue', 'ISpeechPhraseReplacement',
    'DISPID_SPPParent', 'DISPID_SVSkip', 'SVP_15', 'ISpVoice',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRRGetXMLErrorInfo', 'SPWORDLIST',
    'DISPID_SDKGetBinaryValue', 'SpeechVoiceSpeakFlags',
    'DISPID_SAFGetWaveFormatEx', 'SPGRAMMARWORDTYPE',
    'SpSharedRecoContext', 'ISpeechPhraseProperty', 'STCInprocServer',
    'DISPID_SRRGetXMLResult', 'SpeechCategoryRecognizers',
    'ISpeechResourceLoader', 'SDTDisplayText',
    'DISPID_SpeechRecoContextEvents', 'SVEEndInputStream',
    'DISPID_SVDisplayUI', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechWaveFormatEx', 'IStream', 'SPEVENT',
    'DISPID_SABufferInfo', 'DISPID_SpeechPhraseReplacement',
    'SpeechWordType', 'ISpLexicon', 'DISPID_SVSCurrentStreamNumber',
    'SVF_None', 'DISPID_SOTGetAttribute',
    'SpeechRecoProfileProperties', 'SSTTTextBuffer',
    'SPTEXTSELECTIONINFO', 'DISPID_SDKDeleteKey',
    'SpeechWordPronounceable', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPIAudioSizeTime', 'SVF_Emphasis', 'SASPause',
    'DISPID_SOTCEnumerateTokens', 'SAFT16kHz8BitMono',
    'DISPID_SAStatus', 'SpFileStream', 'DISPID_SGRsFindRule',
    'SP_VISEME_8', 'SPINTERFERENCE', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechRecoContext', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_RECO_STATE_CHANGE', 'ISpPhoneConverter', 'SPCT_DICTATION',
    'SPCONTEXTSTATE', 'ISpeechMemoryStream', 'ISpeechGrammarRule',
    'DISPID_SRGetRecognizers', 'DISPID_SAFGuid', 'SPCT_SUB_DICTATION',
    'SVSFNLPMask', 'DISPID_SVGetAudioOutputs',
    'ISpStreamFormatConverter', 'DISPID_SpeechRecognizerStatus',
    'SpAudioFormat', 'DISPID_SDKDeleteValue',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SADefaultFormat',
    'SVEPrivate', 'eLEXTYPE_PRIVATE18', 'eLEXTYPE_PRIVATE2',
    'SPEI_RECO_OTHER_CONTEXT', 'SPGS_DISABLED',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechRecoResult2',
    'DISPID_SRGetPropertyNumber', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPRuleEngineConfidence', 'SREPrivate',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPERequiredConfidence',
    'SAFT44kHz16BitMono', 'SpeechPropertyAdaptationOn',
    'SPEI_HYPOTHESIS', 'DISPID_SRRTimes',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIGetText',
    'DISPID_SRCBookmark', 'DISPID_SPERetainedSizeBytes', 'SITooFast',
    'SAFTCCITT_uLaw_11kHzStereo', 'SGDisplay',
    'DISPID_SpeechPhraseInfo', 'STSF_FlagCreate',
    'SPADAPTATIONRELEVANCE', 'SpeechGrammarTagDictation',
    'DISPID_SpeechVoice', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SGRsCount', 'SpeechAddRemoveWord',
    'SPEI_SR_RETAINEDAUDIO', 'SLODynamic', 'SGDSInactive',
    'ISpeechWaveFormatEx', 'SAFT48kHz8BitMono', 'DISPID_SMSADeviceId',
    'SVSFlagsAsync', 'DISPID_SpeechObjectTokens',
    'ISpeechPhoneConverter', 'SP_VISEME_13', 'SPEI_RECOGNITION',
    'DISPID_SABIBufferSize', 'SVEAudioLevel', 'DISPID_SGRSTsItem',
    'SPRULE', 'SREPropertyNumChange', 'DISPID_SOTIsUISupported',
    'DISPID_SRRTStreamTime', 'DISPID_SVPriority', 'SPEI_MAX_SR',
    'SpeechAudioState', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRSTRule', 'DISPID_SRDisplayUI',
    'DISPID_SGRSAddRuleTransition', 'SGSExclusive',
    'DISPID_SVSpeakStream', 'DISPID_SRRTLength', 'SP_VISEME_16',
    'SPRS_ACTIVE', 'DISPID_SPRuleConfidence',
    'DISPID_SRCCreateGrammar', '_SPAUDIOSTATE',
    'SGLexicalNoSpecialChars', 'DISPID_SRCEAudioLevel',
    'SAFT32kHz16BitMono', 'SpeechLexiconType', 'SpeechRunState',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechPhraseAlternate',
    'eLEXTYPE_VENDORLEXICON', 'SPAS_RUN', 'DISPID_SVVoice',
    'SRAInterpreter', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPAS_STOP', 'SP_VISEME_18', 'SAFT8kHz8BitMono', 'DISPID_SAFType',
    'SpeechRecoEvents', 'SPPROPERTYINFO',
    'DISPID_SpeechPhraseElements', 'DISPID_SVESentenceBoundary',
    'SP_VISEME_19', 'SpObjectTokenCategory', 'SPSHT_NotOverriden',
    'SRTAutopause', 'SDA_One_Trailing_Space', 'DISPID_SGRAttributes',
    'SREBookmark', 'ISpeechPhraseInfoBuilder', 'SPWORDPRONUNCIATION',
    'DISPID_SRAudioInputStream', 'ISequentialStream',
    'DISPID_SGRSAddSpecialTransition', 'SPSTREAMFORMATTYPE',
    'DISPID_SLPPartOfSpeech', 'ISpeechObjectTokens',
    'DISPID_SRCEEndStream', 'SPSEMANTICFORMAT', 'DISPID_SPIElements',
    'SPINTERFERENCE_NOSIGNAL',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEVENTENUM',
    'SP_VISEME_15', 'SPBO_AHEAD', 'SLOStatic', 'STCInprocHandler',
    'DISPID_SPAPhraseInfo', '_RemotableHandle',
    'DISPID_SPEPronunciation', 'SPPS_RESERVED4', 'DISPID_SRState',
    'SpeechVoiceSkipTypeSentence', 'SP_VISEME_20', 'tagSTATSTG',
    'SpeechBookmarkOptions', 'SGDSActiveUserDelimited',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFParseSapi',
    'ISpRecognizer2', 'SDA_Two_Trailing_Spaces',
    'IInternetSecurityManager', 'SpeechVisemeFeature',
    'SPPS_Noncontent', 'DISPID_SPRuleChildren', 'SP_VISEME_7',
    'SpeechStreamFileMode', 'SSFMCreate',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SLPsCount',
    'DISPID_SPARecoResult', 'DISPID_SpeechVoiceStatus',
    'SRCS_Enabled', 'DISPID_SRRAudio', 'SVSFIsFilename',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SASClosed',
    'SPEI_VOICE_CHANGE', 'ISpRecoGrammar', 'SPSHT_OTHER',
    'DISPID_SVSRunningState', 'SITooLoud', 'SPDKL_DefaultLocation',
    'SP_VISEME_11', 'DISPID_SPIAudioSizeBytes', 'SPVPRI_OVER',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE15', 'SPEI_TTS_BOOKMARK',
    'DISPID_SGRSTNextState', 'DISPID_SpeechLexicon',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTId',
    '__MIDL_IWinTypes_0009', 'SVSFPersistXML', 'DISPID_SPEs_NewEnum',
    'DISPID_SPAStartElementInResult', 'DISPID_SRCESoundStart',
    'SAFT32kHz8BitMono', 'SPVPRI_NORMAL', 'SWPKnownWordPronounceable',
    'SP_VISEME_0', 'SPAR_High', 'ISpeechGrammarRuleState',
    'SREStreamEnd', 'SAFTADPCM_22kHzMono', 'ISpResourceManager',
    'SDKLLocalMachine', 'SAFT44kHz8BitMono', 'SpNotifyTranslator',
    'ISpeechPhraseRules', 'ISpeechPhraseInfo', 'SPBO_TIME_UNITS',
    'DISPID_SPRuleName', 'SINoSignal', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SASCurrentDevicePosition', 'SPGS_EXCLUSIVE', 'SRADynamic',
    'SpeechAudioProperties', 'SVPOver', 'DISPID_SOTCId',
    'DISPID_SVSVisemeId', 'IEnumSpObjectTokens',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVEBookmark',
    'SRERecognition', 'DISPID_SPPNumberOfElements',
    'DISPID_SDKGetStringValue', 'SAFT11kHz16BitMono', 'SITooSlow',
    'SPPS_NotOverriden', 'DISPID_SWFEAvgBytesPerSec',
    'SDKLCurrentConfig', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCSetAdaptationData', 'SPEI_START_INPUT_STREAM',
    'DISPID_SVEventInterests', 'ISpPhoneticAlphabetConverter',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechXMLRecoResult',
    'ISpeechRecoGrammar', 'DISPID_SBSFormat', 'SWTAdded',
    'DISPID_SDKOpenKey', 'DISPID_SRRTTickCount', 'ISpeechLexicon',
    'eLEXTYPE_APP', 'DISPID_SPACommit', 'SECHighConfidence',
    'SPPS_RESERVED1', 'SPSERIALIZEDPHRASE', 'SRADefaultToActive',
    'SpeechAllElements', 'Speech_Max_Pron_Length',
    'DISPID_SGRInitialState', 'SVSFNLPSpeakPunc', 'SVSFUnusedFlags',
    'SPSEMANTICERRORINFO', 'DISPID_SVIsUISupported',
    'SpeechAudioFormatGUIDWave', 'SpCompressedLexicon',
    'DISPID_SLPPhoneIds', 'SpeechTokenShellFolder',
    'SAFT11kHz8BitStereo', 'SVSFIsXML', 'SpeechEngineConfidence',
    'SPBINARYGRAMMAR', 'SGSDisabled', 'SPPHRASEPROPERTY',
    'DISPID_SOTCreateInstance', 'DISPID_SLPs_NewEnum', 'SpShortcut',
    'SLTUser', 'SDKLCurrentUser', 'SPPS_RESERVED3',
    'ISpeechObjectTokenCategory', 'DISPID_SRCESoundEnd',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVEViseme',
    'SpeechGrammarWordType', 'SVPNormal', 'SAFTADPCM_8kHzMono',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVAlertBoundary',
    'SpeechTokenContext', 'ISpeechLexiconPronunciation',
    'SAFTADPCM_11kHzStereo', 'SPWT_PRONUNCIATION',
    'SpeechCategoryRecoProfiles', 'DISPID_SGRs_NewEnum',
    'SAFT12kHz8BitMono', 'SPXRO_Alternates_SML', 'SPEI_REQUEST_UI',
    'SAFT48kHz8BitStereo', 'DISPID_SpeechAudioFormat',
    'SREAdaptation', 'SPSNoun', 'DISPID_SPRulesCount',
    'SSFMCreateForWrite', 'SPSFunction', 'DISPID_SpeechGrammarRule',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVSInputSentenceLength',
    'SAFT12kHz8BitStereo', 'SGPronounciation', 'SAFT12kHz16BitMono',
    'SAFT22kHz16BitStereo', 'ISpProperties', 'DISPID_SPIRule',
    'SVP_13', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SVSInputSentencePosition', 'SPEI_UNDEFINED',
    'DISPID_SLRemovePronunciationByPhoneIds', 'LONG_PTR',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechRecoResult',
    'DISPID_SRGDictationSetState', 'SREInterference',
    'SpeechTokenKeyUI', 'SpeechRetainedAudioOptions',
    'SPXMLRESULTOPTIONS', 'SREPropertyStringChange', 'ISpRecognizer3',
    'SPAUDIOSTATE', 'ISpShortcut', 'SVSFPurgeBeforeSpeak',
    'ISpeechAudioStatus', 'SPRECOGNIZERSTATUS', 'DISPID_SPCLangId',
    'ISpeechRecognizerStatus', 'SpeechLoadOption',
    'DISPID_SRCreateRecoContext', 'DISPID_SpeechMMSysAudio', 'SVP_19',
    ...
    'ISpeechPhraseElements', 'SVP_21', 'DISPID_SVSPhonemeId',
    'ISpRecognizer', 'SPRST_NUM_STATES', 'SVP_5',
    'SpeechTokenKeyFiles', 'SpeechPropertyLowConfidenceThreshold',
    'SVPAlert', 'SpeechGrammarState', 'WAVEFORMATEX',
    'ISpeechVoiceStatus', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPEsCount',
    'DISPID_SRCCreateResultFromMemory', 'SDTAlternates',
    'SVSFParseAutodetect', 'SWTDeleted', 'SAFTText', 'SPEI_RESERVED1',
    'DISPID_SRCEHypothesis', 'SAFT24kHz16BitStereo', 'SPRULESTATE',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRStatus',
    'SAFTGSM610_22kHzMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpTextSelectionInformation', 'DISPID_SASCurrentSeekPosition',
    'SPPS_RESERVED2', 'SpMMAudioEnum',
    'DISPID_SpeechPhraseReplacements', 'SPPHRASERULE', 'UINT_PTR',
    'eLEXTYPE_LETTERTOSOUND', 'ISpeechTextSelectionInformation',
    'DISPID_SOTMatchesAttributes', 'SPDKL_LocalMachine',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE8', 'ISpNotifySink',
    'DISPID_SVEStreamStart', 'SpeechCategoryVoices',
    'DISPID_SVStatus', 'SGRSTTEpsilon', 'DISPID_SBSRead',
    'DISPID_SPRuleId', 'eLEXTYPE_PRIVATE11', 'SPBO_NONE', 'SRAImport',
    'DISPID_SPPFirstElement', 'SpeechRecoContextState',
    'SVEVoiceChange', 'DISPID_SRRSaveToMemory', 'SREStateChange',
    'DISPID_SLPType', 'SPEI_PHRASE_START', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCEStartStream', 'DISPID_SMSGetData',
    'SAFT44kHz8BitStereo', 'DISPID_SGRsDynamic',
    'DISPID_SRGSetTextSelection', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SGRSTTWildcard', 'SpeechDataKeyLocation', 'SVP_2',
    'DISPID_SLWPronunciations', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechRecoResultTimes', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCResume', 'SPAO_NONE', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVGetVoices', 'SPEI_INTERFERENCE',
    'DISPID_SVAudioOutputStream', 'DISPID_SPIEnginePrivateData',
    'SPFM_OPEN_READWRITE', 'SINoise', 'ISpSerializeState',
    'SAFT24kHz8BitMono', 'ISpeechRecoResultTimes',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPAsCount',
    'ISpeechRecoContext', 'SVP_17', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCRetainedAudioFormat', 'SPSHORTCUTTYPE',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPEAudioSizeTime', 'SVP_3',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE20',
    'SPLEXICONTYPE', 'DISPID_SMSAMMHandle', 'DISPID_SPRsCount',
    'SLTApp', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRGDictationUnload', 'ISpeechMMSysAudio',
    'DISPID_SOTCDefault', 'SPBOOKMARKOPTIONS', 'SPLOADOPTIONS',
    'SP_VISEME_6', 'SPPARTOFSPEECH', 'SSSPTRelativeToStart',
    'SPAUDIOBUFFERINFO', 'ISpXMLRecoResult',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVGetProfiles',
    'SpNullPhoneConverter', 'SAFT11kHz16BitStereo',
    'DISPID_SPRuleFirstElement', 'DISPID_SPIEngineId',
    'SGRSTTTextBuffer', 'DISPID_SRRAlternates',
    'DISPID_SVEVoiceChange', 'SPSNotOverriden', 'SGRSTTRule',
    'DISPID_SWFESamplesPerSec', 'SAFT22kHz8BitMono',
    'SAFTNonStandardFormat', 'SpStream', 'SPPS_Interjection',
    'ISpObjectWithToken', 'SAFT16kHz16BitMono', 'STCRemoteServer',
    'SPPS_SuppressWord', 'DISPID_SPPsItem', 'DISPID_SRCVoice',
    'DISPID_SGRClear', 'SPBO_PAUSE', 'DISPID_SRCRecognizer',
    'SREAllEvents', 'SpeechRecognitionType',
    'SpeechDisplayAttributes', 'ISpNotifyTranslator',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRGetFormat', 'SPEI_MIN_TTS',
    'ISpAudio', 'SPAR_Low', 'SpPhraseInfoBuilder',
    'DISPID_SABIEventBias', 'STSF_CommonAppData', 'DISPID_SVRate',
    'SPSERIALIZEDRESULT', 'SpUnCompressedLexicon', 'SPAR_Medium',
    'DISPID_SCSBaseStream', 'ISpeechGrammarRuleStateTransition',
    'SPCT_SUB_COMMAND', 'SpeechTokenIdUserLexicon',
    'DISPID_SRCVoicePurgeEvent', 'SPFILEMODE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_START_SR_STREAM', '_ISpeechRecoContextEvents',
    'SpeechAudioFormatGUIDText', 'DISPID_SVEStreamEnd',
    'SPFM_NUM_MODES', 'DISPID_SpeechObjectToken',
    '_ISpeechVoiceEvents', 'SPSMF_UPS', 'SRSEIsSpeaking',
    'DISPID_SPAsItem', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SRGState',
    'SITooQuiet', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpObjectTokenCategory', 'DISPID_SLGetPronunciations',
    'DISPID_SRRecognizer', 'SVP_16', 'SpWaveFormatEx', 'SVSFIsNotXML',
    'SpeechAudioVolume', 'eLEXTYPE_PRIVATE19', 'SRSInactive',
    'DISPIDSPTSI', 'SPRST_ACTIVE', 'DISPID_SpeechVoiceEvent',
    'SpeechRecognizerState', 'DISPID_SPPId', 'SpObjectToken', 'SVP_1',
    'DISPID_SOTsCount', 'SPSModifier', 'DISPID_SpeechCustomStream',
    'SPRECOSTATE', 'SP_VISEME_17', 'ISpObjectToken',
    'ISpPhoneticAlphabetSelection', 'SPPS_Noun',
    'SAFTExtendedAudioFormat', 'SDTRule', 'SPSHORTCUTPAIR',
    'SBOPause', 'DISPID_SRCEFalseRecognition', 'SPVPRIORITY',
    'SpPhoneConverter', 'DISPID_SLPSymbolic', 'DISPID_SLWWord',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRGCmdSetRuleIdState',
    'DISPIDSPTSI_ActiveLength', 'SDA_Consume_Leading_Spaces',
    'SpeechRegistryUserRoot', 'DISPID_SGRSAddWordTransition',
    'SECFNoSpecialChars', 'SRSActive', 'DISPID_SLGenerationId',
    'SP_VISEME_4', 'DISPID_SpeechPhoneConverter',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTRemoveStorageFileName', 'SAFT48kHz16BitStereo',
    'SAFT8kHz16BitStereo', 'DISPID_SGRSRule', 'SECFEmulateResult',
    'SpMMAudioOut', 'SPFM_OPEN_READONLY', 'SPEI_MIN_SR',
    'DISPID_SBSSeek', 'DISPID_SRCEPhraseStart', 'SpeechVoicePriority',
    'SPEI_RESERVED2', 'SVP_10', 'ISpeechPhraseReplacements',
    'SDA_No_Trailing_Space', 'DISPID_SRCERecognition',
    'DISPID_SGRSTText', 'SPAR_Unknown', 'SVP_18',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLAddPronunciation', 'SBONone',
    'SPWORDTYPE', 'SAFTCCITT_ALaw_11kHzMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRSTPropertyId', 'DISPID_SpeechAudioBufferInfo',
    'ISpStream', 'DISPID_SRAudioInput', 'SpeechMicTraining',
    'DISPID_SOTCSetId', 'Speech_StreamPos_RealTime',
    'SpeechAudioFormatType', 'DISPID_SVSpeakCompleteEvent', 'SPWORD',
    'DISPID_SOTCGetDataKey', 'SPPS_LMA', 'ISpeechRecognizer',
    'DISPID_SPRFirstElement', 'SFTInput', 'SPWT_LEXICAL',
    'SPEI_RESERVED5', 'SVF_Stressed', 'IEnumString',
    'DISPID_SPPChildren', 'DISPID_SPISaveToMemory',
    'DISPID_SABIMinNotification', 'Speech_Default_Weight',
    'DISPID_SOTDisplayUI', 'SAFT32kHz16BitStereo', 'SPPS_Verb',
    'STCAll', 'DISPID_SPIReplacements', 'SPEI_MAX_TTS',
    'DISPID_SPRsItem', 'DISPID_SVSLastBookmarkId', 'SREPhraseStart',
    'SREFalseRecognition', 'ISpeechBaseStream', 'ISpRecoContext2',
    'DISPID_SOTsItem', 'DISPID_SRCEPropertyStringChange',
    'eWORDTYPE_DELETED', 'DISPID_SWFEBitsPerSample',
    'SpeechRegistryLocalMachineRoot', 'SRESoundEnd',
    'eLEXTYPE_RESERVED6', 'SPPHRASEELEMENT', 'DISPID_SASetState',
    'SVEViseme', 'DISPID_SpeechBaseStream', 'eLEXTYPE_PRIVATE7',
    'SVP_12', 'eLEXTYPE_PRIVATE3', 'DISPID_SpeechObjectTokenCategory',
    'ISpeechRecoResultDispatch', 'SP_VISEME_9', 'SpeechUserTraining',
    'SDTReplacement', 'DISPID_SPIGrammarId',
    'SWPUnknownWordUnpronounceable', 'SPRECORESULTTIMES',
    'DISPID_SRGRecoContext', 'SPEI_SR_BOOKMARK', 'SVSFVoiceMask',
    'SASRun', 'DISPID_SDKEnumValues', 'SPPHRASE',
    'DISPID_SPRNumberOfElements', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechFileStream', 'ISpRecoResult'
]

_check_version('1.2.0', 1697010846.500271)
